...
class ClientesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('inicioclientes', compact('datos'));
    }
    ...
    return redirect()->route('inicioclientes')->with('success', 'Cliente agregado exitosamente');
    ...
    public function show($id)
    {
        ...
        return view('eliminarclientes', compact('clientes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('inicioclientes')->with('success', 'Cliente actualizado exitosamente');
    }
...
public function destroy($id)
    {
        ...
        $clientes->delete();
        return redirect()->route('inicioclientes')->with('success', 'Cliente eliminado con éxito');
    }
